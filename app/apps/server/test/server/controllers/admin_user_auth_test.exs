defmodule Server.AdminUserAuthTest do
  use Server.ConnCase, async: true

  alias U7406.Admin
  alias Server.AdminUserAuth
  import U7406.AdminFixtures

  @remember_me_cookie "_server_admin_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Server.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Server.Endpoint.subscribe(live_socket_id)
